...
class Player(pygame.sprite.Sprite):
    ...
    def capture_face_position(self):
        ...
        # convert to grayscale, flip the image
        # (head moves left -> paddle moves left)
        ...
        if len(faces) > 0:
            # if we have faces, get the position of the face relative to the screen.
            (x,y,w,h) = faces[0]
            ...
            # We don't actually care about the y position for this game
            return (x_adjusted, y)
        else:
            # If we can't find any faces, keep the paddle where it is
